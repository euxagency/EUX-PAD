...
export default function PickupSettings() {
    ...
    const load = async () => {
        ...
        setNotice(null);
        try {
            const res = await apiFetch({ path: '/wpd/v1/settings/pickup' });
                ...
                <Card>
                    <CardBody>
                        <div className="wpd-admin-section">
                            <div className="wpd-admin-section__title">{__('Pickup & Delivery page —> Pickup tab', 'eux-pad')}</div>
                ...
                <Card>
                    <CardBody>
                        <div className="wpd-admin-section">
                            ...
                            <div className="wpd-admin-section__subtitle">{__('Configure your pickup address and contact', 'eux-pad')}</div>
                            ...
                            <div className="wpd-opening-label">
